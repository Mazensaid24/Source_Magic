...
@app.on_message(
    filters.command(["مميزات","مميزات ماجيك"], "")
& filters.group
 )
async def mmmezat(client, message):
        await message.reply_text(f"""**مرحبآ بك عزيزي » {message.from_user.mention}**في قسم مميزات سورس ماجيك ميوزك\n
⩹━★⊷⌯⌞ 🔱 ѕᴏᴜʀᴄᴇ ᴍᴀɢɪᴄ 🔱 ⌝⌯⊶★━⩺

★قايمه مميزات سورس ماجيك 
            ...
            [
                [
                    InlineKeyboardButton(
                        "★⌞ ѕᴏᴜʀᴄᴇ ᴍᴀɢɪᴄ ⌝⚡", url=f"https://t.me/Fv_av"),                        
                 ],[
                InlineKeyboardButton(
