...
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/Fv_av) /Ma \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/Fv_av)\n [🔱 ѕᴏᴜʀᴄᴇ ᴍᴀɢɪᴄ 🔱](https://t.me/Fv_av)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/Fv_av) """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("الدعم والتواصل", url=f"https://t.me/Ve_G4"),
                
InlineKeyboardButton("لتفعيل كيبورد الاعضاء", callback_data="/Ma"),
                ],
...
※Show entertainment keyboard send /Ma**
""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔙 Go Back", callback_data="english")]]
        ),
...
async def acbadmin(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""※ مرحبا بك \n ※ لتفعيل كيبورد الاعضاء ارسل /Magic \n ※ لتفعيل كيبورد التسليه ارسل /Ma""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("العودة", callback_data="bcmds")]]
        ),
    )
